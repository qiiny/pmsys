<template>
  <div>
    ...
    <el-card style="border-radius: 10px">
      ...
      <el-row :gutter="25">
        <el-col :span="8">
          <el-input placeholder="请输入要搜索的内容" v-model="queryInfo.ownerName" clearable @clear="getAllComplaint">
      ...
      <el-table :data="complaint" border stripe>
        <!--  索引列-->
        <el-table-column prop="complaintid" width="40px">
        </el-table-column>
        <el-table-column label="投诉业主" prop="ownerid" width="180px">
          <template slot-scope="scope">
            {{scope.row.owner.ownername}}
          </template>
        </el-table-column>
        <el-table-column label="业主投诉" prop="complaints"></el-table-column>
        <el-table-column label="是否撤销" prop="revoke" width="180px">
          <template slot-scope="scope">
            {{scope.row.revoke>0?"已撤销":"未撤销"}}
          </template>
        </el-table-column>
    ...
    <el-dialog title="回复" :visible.sync="editDialogVisible" width="40%" @close="addDialogClosed()">
      <el-form :model="editForm"
        ...
        <el-form-item label="回复" prop="noticetitle">
